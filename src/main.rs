...
fn contours_matching() -> Result<(), String> {
    ...
    let mut last_centroid = Point_::<f32>::default();
    ...
    loop {
        ...
        imgproc::bilateral_filter(&grayscale_frame, &mut bilateral_filtered, 5, 75.0, 75.0, BORDER_DEFAULT)
        ...
        let matched_contour = contours
            ...
            .filter(|contour| {
                ...
                if centroids_distance <= 150.0 || last_centroid == (Point_ { x: 0.0, y: 0.0 })  {
            ...
            .fold((0.15, Vector::<Point>::default()), |min_contour, contour| {
